...
const Feed = () => {
  ...
  return (
    <div className="h-dvh flex flex-col bg-background relative" style={{ touchAction: 'pan-y', overscrollBehaviorX: 'none' }}>
      ...
      <div className="flex-1 flex items-center justify-center px-4" style={{ marginTop: 'calc(3.5rem + env(safe-area-inset-top, 0px))', marginLeft: isMobile ? undefined : (collapsed ? '4.5rem' : '15rem'), transition: 'margin-left 0.3s ease' }}>
