    ...
    <div className="h-dvh flex flex-col bg-background relative">
      ...
      {feedTab === "bookmarks" && sortedMarkets.length === 0 ? (
        ...
        <div
          ...
          style={{ height: 'calc(100dvh - 3.5rem - 4rem - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px))', ['--feed-card-height' as any]: 'calc(100dvh - 3.5rem - 4rem - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px))' }}
