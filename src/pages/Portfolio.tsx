...
const Portfolio = () => {
  ...
  if (authLoading) {
    return (
      <div className="min-h-dvh bg-background" style={{ paddingBottom: 'calc(5rem + var(--safe-bottom))' }}>
        <TopBar />
        <div className="max-w-lg md:max-w-4xl mx-auto px-4 flex items-center justify-center min-h-[60dvh]" style={{ paddingTop: 'calc(5rem + var(--safe-top))' }}>
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-dvh bg-background" style={{ paddingBottom: 'calc(5rem + var(--safe-bottom))' }}>
        <TopBar />
        <div className="max-w-lg md:max-w-4xl mx-auto px-4 flex flex-col items-center justify-center min-h-[60dvh]" style={{ paddingTop: 'calc(5rem + var(--safe-top))' }}>
