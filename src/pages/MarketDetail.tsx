...
const MarketDetail = () => {
  ...
  // NOTE: We intentionally do NOT auto-redirect to the next crypto Up/Down
  // round when the current one resolves. The cron spawner creates the next
  // round in the background; users discover it on the Home page. Keeping one
  // URL = one round makes the lifecycle obvious and avoids silent navigation.
