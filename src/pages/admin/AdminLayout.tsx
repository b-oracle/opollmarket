...
import {
  ...
  ArrowLeft, PlusCircle, Receipt, Settings, Coins, Menu, X, ArrowUpFromLine,
} from "lucide-react";
  ...
  return (
    <div className="min-h-dvh bg-background flex">
      ...
      <main className="flex-1 overflow-y-auto min-w-0">
        {/* Mobile header */}
        <div className="sticky top-0 z-30 h-14 flex items-center gap-3 px-4 border-b border-border bg-card/95 backdrop-blur-sm lg:hidden">
          <button
