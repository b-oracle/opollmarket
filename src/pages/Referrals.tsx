...
const Referrals = () => {
  ...
  if (!authLoading && !user) {
    return (
      <div className="min-h-dvh bg-background" style={{ paddingBottom: 'calc(5rem + var(--safe-bottom))' }}>
        <TopBar />
        <div className="max-w-lg md:max-w-3xl mx-auto px-4 flex flex-col items-center justify-center" style={{ minHeight: "60vh", paddingTop: 'calc(5rem + var(--safe-top))' }}>
  ...
  return (
    <div className="h-dvh bg-background overflow-y-auto overscroll-contain" style={{ paddingBottom: 'calc(5rem + var(--safe-bottom))' }}>
      <TopBar />
      <div className="max-w-lg md:max-w-3xl mx-auto px-3 sm:px-4" style={{ paddingTop: 'calc(5rem + var(--safe-top))' }}>
        {/* Header */}
