...
const faqSections = [
  ...
  },
  {
    ...
    items: [
      { question: "What digital assets are supported?", answer: "We support 20+ cryptocurrencies for deposits and withdrawals including stablecoins (USDT, USDC, DAI, BUSD) and popular coins (BTC, ETH, BNB, SOL, MATIC, TRX, XRP, DOGE, LTC, and more) across multiple networks. BC400 is also supported. Availability is subject to network conditions and operational requirements." },
