  ...
  return (
    <>
      ...
      >
        ...
        <div className={`absolute inset-y-3 right-2 sm:right-3 lg:right-4 z-30 flex w-12 sm:w-14 flex-col items-center justify-end gap-1 ${isMulti || isEnded ? 'pb-1' : 'pb-[4.75rem] sm:pb-[5rem]'}`}>
          {isBoosted && (
          ...
          <button onClick={handleLike} className="flex flex-col items-center gap-0.5 group">
            <div className={`${actionIconSizeClass} rounded-full glass flex items-center justify-center transition-colors ${liked ? 'bg-destructive/20' : 'group-hover:bg-destructive/20'}`}>
          ...
          <button onClick={() => setCommentsOpen(true)} className="flex flex-col items-center gap-0.5 group">
            <div className={`${actionIconSizeClass} rounded-full glass flex items-center justify-center group-hover:bg-primary/20 transition-colors`}>
          ...
          <button onClick={handleBookmark} className="flex flex-col items-center gap-0.5 group">
            <motion.div
              className={`${actionIconSizeClass} rounded-full glass flex items-center justify-center transition-colors ${bookmarked ? 'bg-primary/20' : 'group-hover:bg-primary/20'}`}
        ...
        <div className="relative z-10 w-full overflow-visible">
          ...
          <div className="flex items-center gap-2 mb-1.5 pr-14 sm:pr-16">
            <div
          ...
          {market.autoResolve && (
            <div className="flex items-center gap-1.5 mb-2 pr-14 sm:pr-16 overflow-x-auto scrollbar-hide">
          ...
          {isBoosted && boostEndsAt && (
            <div className="mb-2 pr-14 sm:pr-16">
          ...
          <p className="text-[11px] text-muted-foreground mb-2 pr-14 sm:pr-16 line-clamp-2">{market.description}</p>

          <div className="flex items-center gap-3 mb-3 pr-14 sm:pr-16 text-[11px] text-muted-foreground">
