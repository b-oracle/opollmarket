...
const BottomNav = () => {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-[70] glass-strong border-0 shadow-[0_-1px_8px_-2px_hsl(var(--foreground)/0.08)] lg:hidden" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
