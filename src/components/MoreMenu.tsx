...
import { FileText, Shield, AlertTriangle, HelpCircle, ChevronRight, LogIn, Download, Eye, Trash2 } from "lucide-react";
...
const legalLinks = [
  ...
  { icon: Trash2, label: "Delete My Account", path: "/delete-account" },
];
