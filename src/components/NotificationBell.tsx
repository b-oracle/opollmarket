...
import { Bell, X, Check, TrendingUp, RefreshCw, DollarSign, Info, BellRing, UserPlus } from "lucide-react";
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-2 right-2 sm:left-auto sm:right-0 sm:absolute sm:w-80 top-14 sm:top-12 max-h-[70dvh] flex flex-col rounded-xl border border-border shadow-xl z-50 bg-card/90 backdrop-blur-[30px]"
            >
