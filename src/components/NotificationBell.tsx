        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-2 right-2 sm:left-auto sm:right-0 sm:absolute sm:w-80 top-14 sm:top-12 max-h-[70dvh] overflow-y-auto glass-strong rounded-xl border border-border shadow-xl z-50"
            >
