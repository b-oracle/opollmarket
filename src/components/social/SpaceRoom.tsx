                ...
                <div className="relative">
                  ...
                  {showMusicMenu && (
                    <div className="absolute bottom-full right-0 mb-1 bg-card border border-border rounded-lg shadow-lg p-1.5 min-w-[160px] z-[95]">
                      ...
                      <input ref={deviceFileInputRef} type="file" <input ref={deviceFileInputRef} type="file" accept=".mp3,.m4a,.wav,.ogg,.flac,.aac,.wma,.opus,audio/mpeg,audio/mp4,audio/wav,audio/ogg,audio/flac,audio/aac" className="hidden" onChange={handleDeviceMusicFile} />
                      {!deviceMusicPlaying ? (
