...
const DesktopFooter = () => {
  ...
  return (
    <footer className="hidden md:block fixed bottom-0 right-0 left-60 z-40 border-t border-border bg-background/95 backdrop-blur-sm">
      <div className="max-w-4xl xl:max-w-6xl mx-auto px-6 py-10">
