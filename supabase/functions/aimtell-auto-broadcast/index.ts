...
import { verifyInternalOrAdmin, internalAuthHeader } from "../_shared/internalAuth.ts";
...
Deno.serve(async (req) => {
  ...
  const auth = await verifyInternalOrAdmin(req, { functionName: "aimtell-auto-broadcast", corsHeaders });
