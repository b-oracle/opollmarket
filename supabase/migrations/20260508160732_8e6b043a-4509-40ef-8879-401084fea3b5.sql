...
BEGIN
  ...
  _bonus_for_fee := LEAST(COALESCE(_balance.bonus_balance, 0), _fee_amount);
  ...
  IF _escrow_id IS NOT NULL THEN
    ...
    VALUES (_caller, 'buy', _escrow.amount, _market_id, 'confirmed', 'market_creation_fee', 'Market creation fee applied (escrow released)');
