...
-- Add pinned_trending column
ALTER TABLE public.markets ADD COLUMN IF NOT EXISTS pinned_trending boolean NOT NULL DEFAULT false;

-- Update the trending algorithm to always include pinned markets
